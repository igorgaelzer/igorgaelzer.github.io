...
<?php echo form_open((isset($price_list)) ? 'price_list/update/'.$price_list->id : 'price_list/add', array('class' => 'form', 'role' => 'form')); ?>
    ...
    <div class="row">
		  ...
		  <div class="form-group col-md-6">
		    ...
		    <?php echo form_input(array('name' => 'client', 'class' => 'form-control')); ?>
		  </div>
	</div>
	...
	<div class="row">
		<div class="form-group col-md-6">		
	    	...
	    	<?php echo form_dropdown('multiplier_id', $multipliers_list, '', 'class="form-control"'); ?>
	  	</div>	
	</div>
